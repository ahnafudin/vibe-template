...
**On honesty:** 67 entries are verified — most of them against a project the framework's own
creator produced, on GitHub's runners (`.github/workflows/verify-stacks.yml`). The remaining
**3 are marked `"verified": false`**, and their generated `docs/STACK.md` carries a visible
